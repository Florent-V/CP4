...
class Member
{
    ...
    #[ORM\OneToMany(mappedBy: 'fromMember', targetEntity: Transfer::class, orphanRemoval: true)]
    private Collection $transfersGiven;

    #[ORM\OneToMany(mappedBy: 'toMember', targetEntity: Transfer::class, orphanRemoval: true)]
