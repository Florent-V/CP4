 ...
 */
final class Version20240323141925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE expense (id INT AUTO_INCREMENT NOT NULL, paid_by_id INT NOT NULL, splitter_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', category_id INT NOT NULL, name VARCHAR(100) NOT NULL, created_at DATE NOT NULL, made_at DATE NOT NULL, amount DOUBLE PRECISION NOT NULL, picture VARCHAR(255) DEFAULT NULL, devise VARCHAR(5) NOT NULL, INDEX IDX_2D3A8DA67F9BC654 (paid_by_id), INDEX IDX_2D3A8DA6E8DFE41 (splitter_id), INDEX IDX_2D3A8DA612469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
