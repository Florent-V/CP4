 ...
 *         upload_destination: scalar|null,
 *         namer?: string|array{
 ...
 *     favicons?: bool|array{
 *         enabled?: bool, // Default: false
 *         src: scalar|null, // The source of the favicon. Shall be a SVG or large PNG.
 *         background_color?: scalar|null, // The background color of the application. If this value is not defined and that of the Manifest section is, the value of the latter will be used. // Default: null
 *         safari_pinned_tab_color?: scalar|null, // The color of the Safari pinned tab. Requires "use_silhouette" to be set to "true". // Default: null
 *         tile_color?: scalar|null, // The color of the tile for Windows 8+. // Default: null
 *         border_radius?: int, // The border radius of the icon. // Default: null
 *         image_scale?: int, // The scale of the icon. // Default: null
 *         low_resolution?: bool, // Include low resolution icons. // Default: false
 *         use_silhouette?: bool|null, // Use only the silhouette of the icon. Applicable for macOS Safari and Windows 8+. Requires potrace to be installed. // Default: null
 *         potrace?: scalar|null, // The path to the potrace binary. // Default: "potrace"
 *     },
 *     image_processor?: scalar|null, // The image processor to use to generate the icons of different sizes. // Default: null
 *     logger?: scalar|null, // The logger service to use. If not set, the default logger will be used. // Default: null
 *     manifest?: bool|array{
 *         enabled?: bool, // Default: false
 *         public_url?: scalar|null, // The public URL of the manifest file. // Default: "/site.webmanifest"
 *         use_credentials?: bool, // Indicates whether the manifest should be fetched with credentials. // Default: true
 *         background_color?: scalar|null, // The background color of the application. It should match the background-color CSS property in the sites stylesheet for a smooth transition between launching the web application and loading the site's content.
 *         categories?: list<scalar|null>,
 *         description?: scalar|null, // The description of the application.
 *         display?: scalar|null, // The display mode of the application.
 *         display_override?: list<scalar|null>,
 *         id?: scalar|null, // A string that represents the identity of the web application.
 *         orientation?: scalar|null, // The orientation of the application.
 *         dir?: scalar|null, // The direction of the application.
 *         lang?: scalar|null, // The language of the application.
 *         name?: scalar|null, // The name of the application.
 *         short_name?: scalar|null, // The short name of the application.
 *         scope?: scalar|null, // The scope of the application.
 *         start_url?: scalar|null, // The start URL of the application.
 *         theme_color?: scalar|null, // The theme color of the application. If a dark theme color is specified, the theme color will be used for the light theme.
 *         dark_theme_color?: scalar|null, // The dark theme color of the application.
 *         edge_side_panel?: array{ // Specifies whether or not your app supports the side panel view in Microsoft Edge.
 *             preferred_width?: int, // Specifies the preferred width of the side panel view in Microsoft Edge.
 *         },
 *         iarc_rating_id?: scalar|null, // Specifies the International Age Rating Coalition (IARC) rating ID for the app. See https://www.globalratings.com/how-iarc-works.aspx for more information.
 *         scope_extensions?: list<array{ // Default: []
 *             origin: scalar|null, // Specifies the origin pattern to associate with.
 *         }>,
 *         handle_links?: scalar|null, // Specifies the default link handling for the web app.
 *         icons?: list<string|array{ // Default: []
 *             src: scalar|null, // The path to the icon. Can be served by Asset Mapper.
 *             sizes?: list<int>,
 *             type?: scalar|null, // The icon mime type.
 *             purpose?: scalar|null, // The purpose of the icon.
 *         }>,
 *         screenshots?: list<string|array{ // Default: []
 *             src?: scalar|null, // The path to the screenshot. Can be served by Asset Mapper.
 *             height?: scalar|null, // Default: null
 *             width?: scalar|null, // Default: null
 *             form_factor?: scalar|null, // The form factor of the screenshot. Will guess the form factor if not set.
 *             label?: scalar|null, // The label of the screenshot.
 *             platform?: scalar|null, // The platform of the screenshot.
 *             format?: scalar|null, // The format of the screenshot. Will convert the file if set.
 *             reference?: scalar|null, // The URL of the screenshot. Only for reference and not used by the bundle. // Default: null
 *         }>,
 *         file_handlers?: list<array{ // Default: []
 *             action?: string|array{ // The action to take.
 *                 path: scalar|null, // The URL or route name.
 *                 path_type_reference?: int, // The path type reference to generate paths/URLs. See https://symfony.com/doc/current/routing.html#generating-urls-in-controllers for more information. // Default: 1
 *                 params?: list<mixed>,
 *             },
 *             accept?: array<string, list<scalar|null>>,
 *         }>,
 *         launch_handler?: array{ // The launch handler of the application.
 *             client_mode?: list<scalar|null>,
 *         },
 *         protocol_handlers?: list<array{ // Default: []
 *             protocol: scalar|null, // The protocol of the handler.
 ...
 *             },
 *         }>,
 *         prefer_related_applications?: bool, // prefer related native applications (instead of this application) // Default: false
 *         related_applications?: list<array{ // Default: []
 *             platform: scalar|null, // The platform of the application.
 *             url?: string|array{ // The URL of the application.
 *                 path: scalar|null, // The URL or route name.
 *                 path_type_reference?: int, // The path type reference to generate paths/URLs. See https://symfony.com/doc/current/routing.html#generating-urls-in-controllers for more information. // Default: 1
 *                 params?: list<mixed>,
 *             },
 *             id?: scalar|null, // The ID of the application.
 *         }>,
 *         shortcuts?: list<array{ // Default: []
 *             name: scalar|null, // The name of the shortcut.
 *             short_name?: scalar|null, // The short name of the shortcut.
 *             description?: scalar|null, // The description of the shortcut.
 ...
 *                 params?: list<mixed>,
 *             },
 *             method?: scalar|null, // The method of the share target.
 *             enctype?: scalar|null, // The enctype of the share target. Ignored if method is GET.
 *             params: array{ // The parameters of the share target.
 *                 title?: scalar|null, // The title of the share target.
 *                 text?: scalar|null, // The text of the share target.
 *                 url?: scalar|null, // The URL of the share target.
 *                 files?: list<scalar|null>,
 *             },
 *         },
 *         widgets?: list<array{ // Default: []
 *             name: scalar|null, // The title of the widget, presented to users.
 *             short_name?: scalar|null, // An alternative short version of the name.
 *             description: scalar|null, // The description of the widget.
 *             icons?: list<string|array{ // Default: []
 *                 src: scalar|null, // The path to the icon. Can be served by Asset Mapper.
 *                 sizes?: list<int>,
 *                 type?: scalar|null, // The icon mime type.
 ...
 *                 reference?: scalar|null, // The URL of the screenshot. Only for reference and not used by the bundle. // Default: null
 *             }>,
 *             tag: scalar|null, // A string used to reference the widget in the PWA service worker.
 *             template?: scalar|null, // The template to use to display the widget in the operating system widgets dashboard. Note: this property is currently only informational and not used. See ms_ac_template below.
 ...
 *                 params?: list<mixed>,
 *             },
 *             type?: scalar|null, // The MIME type for the widget data.
 *             auth?: bool, // A boolean indicating if the widget requires authentication.
 *             update?: int, // The frequency, in seconds, at which the widget will be updated. Code in your service worker must perform the updating; the widget is not updated automatically. See Access widget instances at runtime.
 *             multiple?: bool, // A boolean indicating whether to allow multiple instances of the widget. Defaults to true. // Default: true
 *         }>,
 *     },
 *     path_type_reference?: int, // Deprecated: The "path_type_reference" configuration key is deprecated. Use the "path_type_reference" of URL nodes instead. // The path type reference to generate paths/URLs. See https://symfony.com/doc/current/routing.html#generating-urls-in-controllers for more information. // Default: 1
 *     serviceworker?: bool|string|array{
 *         enabled?: bool, // Default: false
 *         src?: scalar|null, // The path to the service worker source file. Can be served by Asset Mapper.
 *         dest?: scalar|null, // The public URL to the service worker. // Default: "/sw.js"
 *         skip_waiting?: bool, // Whether to skip waiting for the service worker to be activated. // Default: false
 *         scope?: scalar|null, // The scope of the service worker. // Default: "/"
 *         use_cache?: bool, // Whether the service worker should use the cache. // Default: true
 *         workbox?: bool|array{ // The configuration of the workbox.
 *             enabled?: bool, // Default: true
 *             use_cdn?: bool, // Whether to use the local workbox or the CDN. // Default: false
 *             google_fonts?: bool|array{
 *                 enabled?: bool, // Default: true
 *                 cache_prefix?: scalar|null, // The cache prefix for the Google fonts. // Default: null
 *                 max_age?: scalar|null, // The maximum age of the Google fonts cache (in seconds). // Default: null
 *                 max_entries?: int, // The maximum number of entries in the Google fonts cache. // Default: null
 *             },
 *             cache_manifest?: bool, // Whether to cache the manifest file. // Default: true
 *             version?: scalar|null, // The version of workbox. When using local files, the version shall be "7.0.0." // Default: "7.0.0"
 *             workbox_public_url?: scalar|null, // The public path to the local workbox. Only used if use_cdn is false. // Default: "/workbox"
 *             workbox_import_placeholder?: scalar|null, // Deprecated: The "workbox_import_placeholder" option is deprecated and will be removed in 2.0.0. No replacement. // The placeholder for the workbox import. Will be replaced by the workbox import. // Default: "//WORKBOX_IMPORT_PLACEHOLDER"
 *             standard_rules_placeholder?: scalar|null, // Deprecated: The "standard_rules_placeholder" option is deprecated and will be removed in 2.0.0. No replacement. // The placeholder for the standard rules. Will be replaced by caching strategies. // Default: "//STANDARD_RULES_PLACEHOLDER"
 *             offline_fallback_placeholder?: scalar|null, // Deprecated: The "offline_fallback_placeholder" option is deprecated and will be removed in 2.0.0. No replacement. // The placeholder for the offline fallback. Will be replaced by the URL. // Default: "//OFFLINE_FALLBACK_PLACEHOLDER"
 *             widgets_placeholder?: scalar|null, // Deprecated: The "widgets_placeholder" option is deprecated and will be removed in 2.0.0. No replacement. // The placeholder for the widgets. Will be replaced by the widgets management events. // Default: "//WIDGETS_PLACEHOLDER"
 *             clear_cache?: bool, // Whether to clear the cache during the service worker activation. // Default: true
 ...
 *                 enabled?: bool, // Default: true
 *                 cache_name?: scalar|null, // The name of the image cache. // Default: "images"
 *                 regex?: scalar|null, // The regex to match the images. // Default: "/\\.(ico|png|jpe?g|gif|svg|webp|bmp)$/"
 *                 max_entries?: int, // The maximum number of entries in the image cache. // Default: 60
 *                 max_age?: scalar|null, // The maximum number of seconds before the image cache is invalidated. // Default: 31536000
 *             },
 *             asset_cache?: bool|array{
 *                 enabled?: bool, // Default: true
 *                 cache_name?: scalar|null, // The name of the asset cache. // Default: "assets"
 *                 regex?: scalar|null, // The regex to match the assets. // Default: "/\\.(css|js|json|xml|txt|map|ico|png|jpe?g|gif|svg|webp|bmp)$/"
 *                 max_age?: scalar|null, // The maximum number of seconds before the asset cache is invalidated. // Default: 31536000
 *             },
 *             font_cache?: bool|array{
 *                 enabled?: bool, // Default: true
 *                 cache_name?: scalar|null, // The name of the font cache. // Default: "fonts"
 *                 regex?: scalar|null, // The regex to match the fonts. // Default: "/\\.(ttf|eot|otf|woff2)$/"
 *                 max_entries?: int, // The maximum number of entries in the image cache. // Default: 60
 *                 max_age?: int, // The maximum number of seconds before the font cache is invalidated. // Default: 31536000
 *             },
 *             resource_caches?: list<array{ // Default: []
 *                 match_callback: scalar|null, // The regex or callback function to match the URLs.
 *                 cache_name?: scalar|null, // The name of the page cache.
 *                 network_timeout?: int, // The network timeout in seconds before cache is called (for "NetworkFirst" and "NetworkOnly" strategies). // Default: 3
 *                 strategy?: scalar|null, // The caching strategy. Only "NetworkFirst", "CacheFirst" and "StaleWhileRevalidate" are supported. // Default: "NetworkFirst"
 *                 max_entries?: scalar|null, // The maximum number of entries in the cache (for "CacheFirst" and "NetworkFirst" strategy only). // Default: null
 *                 max_age?: scalar|null, // The maximum number of seconds before the cache is invalidated (for "CacheFirst" and "NetWorkFirst" strategy only). // Default: null
 *                 broadcast?: bool, // Whether to broadcast the cache update events (for "StaleWhileRevalidate" strategy only). // Default: false
 *                 range_requests?: bool, // Whether to support range requests (for "CacheFirst" strategy only). // Default: false
 *                 cacheable_response_headers?: list<scalar|null>,
 *                 cacheable_response_statuses?: list<int>,
 *                 broadcast_headers?: list<scalar|null>,
 *                 preload_urls?: list<string|array{ // Default: []
 *                     path: scalar|null, // The URL of the shortcut.
 *                     params?: list<mixed>,
 *                 }>,
 *             }>,
 *             background_sync?: list<array{ // Default: []
 *                 queue_name: scalar|null, // The name of the queue.
 *                 match_callback: scalar|null, // The regex or callback function to match the URLs.
 *                 method?: scalar|null, // The HTTP method. // Default: "POST"
 *                 broadcast_channel?: scalar|null, // The broadcast channel. Set null to disable. // Default: null
 *                 max_retention_time?: int, // The maximum retention time in minutes. // Default: 1440
 *                 force_sync_fallback?: bool, // If `true`, instead of attempting to use background sync events, always attempt to replay queued request at service worker startup. Most folks will not need this, unless you explicitly target a runtime like Electron that exposes the interfaces for background sync, but does not have a working implementation. // Default: false
 *             }>,
 *             image_cache_name?: scalar|null, // Deprecated: The "image_cache_name" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.image_cache.cache_name" instead. // The name of the image cache. // Default: "images"
 *             font_cache_name?: scalar|null, // Deprecated: The "font_cache_name" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.font_cache.cache_name" instead. // The name of the font cache. // Default: "fonts"
 *             page_cache_name?: scalar|null, // Deprecated: The "page_cache_name" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.resource_caches[].cache_name" instead. // The name of the page cache. // Default: "pages"
 *             asset_cache_name?: scalar|null, // Deprecated: The "asset_cache_name" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.asset_cache.cache_name" instead. // The name of the asset cache. // Default: "assets"
 ...
 *                 params?: list<mixed>,
 *             },
 *             image_regex?: scalar|null, // Deprecated: The "image_regex" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.image_cache.regex" instead. // The regex to match the images. // Default: "/\\.(ico|png|jpe?g|gif|svg|webp|bmp)$/"
 *             static_regex?: scalar|null, // Deprecated: The "static_regex" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.asset_cache.regex" instead. // The regex to match the static files. // Default: "/\\.(css|js|json|xml|txt|map)$/"
 *             font_regex?: scalar|null, // Deprecated: The "font_regex" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.font_cache.regex" instead. // The regex to match the static files. // Default: "/\\.(ttf|eot|otf|woff2)$/"
 *             max_image_cache_entries?: int, // Deprecated: The "max_image_cache_entries" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.image_cache.max_entries" instead. // The maximum number of entries in the image cache. // Default: 60
 *             max_image_age?: int, // Deprecated: The "max_image_age" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.image_cache.max_age" instead. // The maximum number of seconds before the image cache is invalidated. // Default: 31536000
 *             max_font_cache_entries?: int, // Deprecated: The "max_font_cache_entries" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.font_cache.max_entries" instead. // The maximum number of entries in the font cache. // Default: 30
 *             max_font_age?: int, // Deprecated: The "max_font_age" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.font_cache.max_age" instead. // The maximum number of seconds before the font cache is invalidated. // Default: 31536000
 *             network_timeout_seconds?: int, // Deprecated: The "network_timeout_seconds" option is deprecated and will be removed in 2.0.0. Please use "pwa.serviceworker.workbox.resource_caches[].network_timeout" instead. // The network timeout in seconds before cache is called (for warm cache URLs only). // Default: 3
